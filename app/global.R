...
brottsdata <- tbl(shiny_uppkoppling_las("oppna_data"), dbplyr::in_schema("polisen", "brott")) %>%
...
# läs in från vår postgres-databas som heter oppna_data
brott_niva_nyckel <- tbl(shiny_uppkoppling_las("oppna_data"), dbplyr::in_schema("polisen", "brott_niva_nyckel")) %>%
  collect()
